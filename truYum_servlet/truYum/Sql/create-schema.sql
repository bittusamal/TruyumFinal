...
CREATE TABLE IF NOT EXISTS `truyum`.`menu_item` (
  ...
  `me-name` VARCHAR(100) NULL DEFAULT NULL,
  `me_price` DECIMAL(8,2) NULL DEFAULT NULL,
  `me-active` VARCHAR(3) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `truyum`.`user-table`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `truyum`.`user-table` (
...
-- -----------------------------------------------------
-- Table `truyum`.`cart_table`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `truyum`.`cart_table` (
  ...
  CONSTRAINT `ct_us_id`
    ...
    REFERENCES `truyum`.`user-table` (`us_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
